...
;(function (root, factory) {
	...
	var eventHandlers = ['clickHandler'];
	...
	Select.prototype.createNewSelect = function (el, selectArray, optionsArray) {
		...
		selectArray.forEach(function (item, i) {
			_this2.newSelect.setAttribute('data-' + item.name, item.value);
		});
